...
modules in Python. I went ahead and  practiced using the builtin function
`dir()` and using command line arguments within Python programs. This is so amazing to me.
...
* **9. Fast alphabet**
  ...
  * Without using loops, conditoinals, `str.join()`, string literals, 
